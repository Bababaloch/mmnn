...
#----[remover]-----
	...
	sz=""#--checking if file is not avalible 
...
def qsbuy():
	...
	try:
		...
		try:
			...
			os.system(f"termux-open-url https://wa.me/+923301579625?text={bumper}")
...
def main():
	...
	if menu_opt =='1':
		...
		os.system('xdg-open https://github.com/Bababaloch/baba.git')
